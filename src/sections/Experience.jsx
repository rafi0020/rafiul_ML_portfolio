...
const experiences = [
  {
    ...
    description: "Architected and deployed 10+ production-grade computer vision systems for enterprise clients including Unilever, BAT, and KDS. Led full ML lifecycle: data annotation, model development (custom YOLO, PaddleOCR), edge deployment (NVIDIA Jetson), and on-site integration. Engineered specialized solutions: ISO 6346-compliant container tracking with >98% accuracy and <50ms latency, real-time SOP monitoring across 150+ cameras, Bangla ANPR achieving ~94% accuracy, multi-modal threat detection with depth estimation, and counterfeit detection systems. Conducted extensive R&D on pose estimation (MediaPipe, MMpose, YOLO-pose), object tracking (DeepSORT, ByteTrack, StrongSORT), and LLM fine-tuning (DeepSeek R1). Reduced operational costs by 60-90% through AI automation.",
    tech: ["YOLOv8/v11", "PaddleOCR", "TensorRT", "NVIDIA Jetson", "DeepSORT", "MediaPipe", "InsightFace", "Depth-Anything-V2", "FastAPI", "Docker", "OpenCV", "SAHI"]
  },
  {
