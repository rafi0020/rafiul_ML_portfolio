...
const skillCategories = [
  {
    ...
    icon: "👁️",
    skills: ["YOLO (v5/v8/OBB)", "OpenCV", "Object Detection", "Image Segmentation", "OCR (PaddleOCR)", "Tracking (DeepSORT/ByteTrack)", "SAHI", "Pose Estimation", "MediaPipe"],
    bars: [
      { name: "Object Detection & YOLO", level: 95 },
