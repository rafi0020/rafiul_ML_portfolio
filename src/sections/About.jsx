              ...
              <div className="content-card-body">
                <div className="expertise-grid">
                  <div className="expertise-item">
                    ...
                    <p>Object Detection (YOLO v5/v8/OBB), Pose Estimation (MediaPipe), OCR (PaddleOCR), Face Recognition (InsightFace), Multi-Object Tracking (DeepSORT, ByteTrack), OpenCV</p>
                  </div>
                  <div className="expertise-item">
                    <div className="expertise-header">
